...
namespace UnitTestProject1
{
    public class AdventOfCode2017Tests
    {
        ...
        [Theory(DisplayName = "CorruptionChecksum")]
        [InlineData(@"5 1 9 5
7 5 3
2 4 6 8", 18)]
        [InlineData(@"626	2424	2593	139	2136	163	1689	367	2235	125	2365	924	135	2583	1425	2502
...
2257    155 734 228 204 2180    175 2277    180 2275    2239    2331    2278    1763    112 2054", 0)]
        public void TestCorruptionChecksum(string input, int @is)
        {
            Assert.Equal(@is, AdventOfCode2017.AdventOfCode2017.CorruptionChecksum(input));
        }
    }
}
